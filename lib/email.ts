          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
              ...
              <p style="color: #cccccc; font-size: 11px; margin: 20px 0 0 0;">
                © ${new Date().getFullYear()} Scale AI - Sistema de Atendimento Inteligente
              </p>
            </td>
          </tr>
...
export async function sendRecoveryEmail(
  ...
  const msg = {
    to: email,
    from: process.env.SENDGRID_FROM_EMAIL,
    subject: 'Recuperação de Senha - Scale AI',
    text: `
Olá,

Você solicitou a recuperação de sua senha no Scale AI.
